...
<div class="quiz-window">
	...
	<div class="quiz-window-body">
		<div class="col2">
			<f:form modelAttribute="k" action="../fac/crud">
				<f:label path="id">id</f:label>
				<f:input path="id" maxlength="19" placeholder="id" />
				<label>montant</label>
				<f:input path="montant" maxlength="19" placeholder="cin" />
				<label>description</label>
				<f:input path="descri" maxlength="19" placeholder="nom" />
			...
			<c:if test="${not empty list}">
				...
				<c:forEach items="${list}" var="f">
					<ul class="guiz-awards-row guiz-awards-row-even">
						...
						<li class="guiz-awards-title">${f.descri}</li>

						<li class="guiz-awards-track"></li>
							<a
								href="${pageContext.request.contextPath}/fac/update/${f.id}"
							...
							<a
								href="${pageContext.request.contextPath}/fac/delete/${f.id}"
								class="btn btn-primary a-btn-slide-text"> <span
